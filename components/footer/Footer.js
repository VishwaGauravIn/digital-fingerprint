...
export default function Footer() {
  return (
    <div className="flex flex-col w-full justify-center items-center mt-8 sm:pt-16">
      ...
      <div className="w-full flex justify-center items-center text-malibu-200">
        <a
          href="https://itsvg.in"
...
export const LINKEDIN_SVG = ({ size }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
